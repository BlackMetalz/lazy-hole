...
- Third, fix issue that apply rule for group that doesn't show immediately

- Fourth, when I exit TUI, it still show 0 active rule on hosts. --> need to correction. Count total effects instead of check `effectTracker.GetAll()` > 0